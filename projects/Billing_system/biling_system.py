...
class Bill_App:
    def __init__(self, root):
        ...
        bg_color = "#6495ED"
        title = Label(self.root, text="Billing Software", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#6495ED", fg="Black", relief=GROOVE)
        title.pack(fill=X)
    # ================variables=======================
    ...
    # =============customer retail details======================
        F1 = LabelFrame(self.root, text="Customer Details", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#6495ED")
        ...
        cphn_lbl = Label(F1, text="Customer Phone:", bg="#6495ED", font=('times new roman', 15, 'bold'))
        ...
        c_bill_lbl = Label(F1, text="Bill Number:", bg="#6495ED", font=('times new roman', 15, 'bold'))
    ...
    # ===================Medical====================================
        F2 = LabelFrame(self.root, text="Medical Purpose", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#6495ED")
        F2.place(x=5, y=180, width=325, height=380)

        sanitizer_lbl = Label(F2, text="Sanitizer", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        mask_lbl = Label(F2, text="Mask", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        hand_gloves_lbl = Label(F2, text="Hand Gloves", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        dettol_lbl = Label(F2, text="Dettol", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        newsprin_lbl = Label(F2, text="Newsprin", font =('times new roman', 16, 'bold'), bg = "#6495ED", fg = "black")
        ...
        thermal_gun_lbl = Label(F2, text="Thermal Gun", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
    ...
    # ==========GroceryItems=========================
        F3 = LabelFrame(self.root, text="Grocery Items", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#6495ED")
        F3.place(x=340, y=180, width=325, height=380)

        rice_lbl = Label(F3, text="Rice", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        food_oil_lbl = Label(F3, text="Food Oil", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        wheat_lbl = Label(F3, text="Wheat", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        daal_lbl = Label(F3, text="Daal", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        flour_lbl = Label(F3, text="Flour", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        maggi_lbl = Label(F3, text="Maggi", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
    ...
    # ===========ColdDrinks================================
        F4 = LabelFrame(self.root, text="Cold Drinks", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#6495ED")
        F4.place(x=670, y=180, width=325, height=380)

        sprite_lbl = Label(F4, text="Sprite", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        limka_lbl = Label(F4, text="Limka", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        mazza_lbl = Label(F4, text="Mazza", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        coke_lbl = Label(F4, text="Coke", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        fanta_lbl = Label(F4, text="Fanta", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
        ...
        mountain_duo_lbl = Label(F4, text="Mountain Duo", font=('times new roman', 16, 'bold'), bg="#6495ED", fg="black")
    ...
    # =======================ButtonFrame=============
        F6 = LabelFrame(self.root, text="Bill Area", font=('times new roman', 14, 'bold'), bd=10, fg="Black", bg="#6495ED")
        F6.place(x=0, y=560, relwidth=1, height=140)

        m1_lbl = Label(F6, text="Total Medical Price", font=('times new roman', 14, 'bold'), bg="#6495ED", fg="black")
        ...
        m2_lbl = Label(F6, text="Total Grocery Price", font=('times new roman', 14, 'bold'), bg="#6495ED", fg="black")
        ...
        m3_lbl = Label(F6, text="Total Cold Drinks Price", font=('times new roman', 14, 'bold'), bg="#6495ED", fg="black")
        ...
        m4_lbl = Label(F6, text="Medical Tax", font=('times new roman', 14, 'bold'), bg="#6495ED", fg="black")
        ...
        m5_lbl = Label(F6, text="Grocery Tax", font=('times new roman', 14, 'bold'), bg="#6495ED", fg="black")
        ...
        m6_lbl = Label(F6, text="Cold Drinks Tax", font=('times new roman', 14, 'bold'), bg="#6495ED", fg="black")
