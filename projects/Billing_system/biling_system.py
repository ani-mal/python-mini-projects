...
class Bill_App:
    def __init__(self, root):
        ...
        title = Label(self.root, text="Billing Software", font=(
            'times new roman', 30, 'bold'), pady=2, bd=12, bg="#badc89", fg="Black", relief=GROOVE)
        title.pack(fill=X)
    # ================variables=======================
    ...
    # =============customer retail details======================
        F1 = LabelFrame(self.root, text="Customer Details", font=(
            'times new roman', 15, 'bold'), bd=10, fg="Black", bg="#badc89")
        ...
        cphn_lbl = Label(F1, text="Customer Phone:", bg="#badc89",
                         font=('times new roman', 15, 'bold'))
        ...
        c_bill_lbl = Label(F1, text="Bill Number:", bg="#badc89",
                           font=('times new roman', 15, 'bold'))
    ...
    # ===================Medical====================================
        ...
        sanitizer_lbl = Label(F2, text="Sanitizer", font=(
            'times new roman', 16, 'bold'), bg="#badc89", fg="black")
    ...
    # =======================ButtonFrame=============
        F6 = LabelFrame(self.root, text="Bill Area", font=(
            'times new roman', 14, 'bold'), bd=10, fg="Black", bg="#badc89")
        F6.place(x=0, y=560, relwidth=1, height=140)

        m1_lbl = Label(F6, text="Total Medical Price", font=(
            'times new roman', 14, 'bold'), bg="#badc89", fg="black")
